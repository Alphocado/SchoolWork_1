...
class MainActivity : AppCompatActivity() {
    private lateinit var cvItem: RecyclerView // Change variable name to cvItem
    ...
    private fun init() {
        cvItem = findViewById(R.id.rv_item) // Use cvItem instead of rvItem
        cvItem.layoutManager = LinearLayoutManager(this)
        adapter = RvAdapter(this, arrayListOf())
        cvItem.adapter = adapter
    }
